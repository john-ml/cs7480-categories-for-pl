...
\begin{proposition}
  ...
  is equivalent to a representation for the \(\calC\)-indexed set \(P\) defined by
  \[
...
\todo{get this from the blackboard or someone's notes}
...
\begin{definition}[Morphism of cocones]
  Let \(D : \mathcal I \to \calC\) be a diagram of shape \(\mathcal I\)
  in a category \(\calC\).
...
Then, the category of cocones for a diagram $\mathcal{D}$ is 
