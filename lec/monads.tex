...
\end{align*}
The action of this functor on morphisms sends function \(f\)
...
\begin{align*}
  ...
  &\mu_{\calV}(\plifflip{p}{e_1}{e_2}) = \plifflip{p}{e_1}{e_2} \\
\end{align*}
...
flattens a tree whose leaves are trees into a tree whose leaves are values.
...
\begin{itemize}
    ...
    description of a monad''. \begin{itemize}
      ...
      \item Moggi's insight: this is a recipe for modelling effects more generally:
        start from a syntactic description, add equations one expects should hold,
        and try to see what matheamtical objects come out.
