...
\end{proposition}
\begin{proof}
  Since this is our first interesting proof we will a fully diagrammatic argument.
...
\begin{tikzcd}[column sep = huge]
  & A \times B \arrow[d, "{\langle \pi_1, \pi_2 \rangle}"] \arrow[lddd, "\pi_1"', bend right] \arrow[rddd, "\pi_2", bend left] &   \\
