...
\inferrule
    ...
    {\Gamma \vdash \plfst{\plpair{M}{N}} \equiv M : A}~(\beta_1)
\and
\inferrule
    {\Gamma\vdash M : A
      \\
    ...
    {\Gamma \vdash \plsnd{\plpair{M}{N}} \equiv N : B}~(\beta_2)
\end{mathpar}
...
\inferrule
    ...
    {\Gamma \vdash M \equiv \plpair{\plfst{M}}{\plsnd{M}} : A \pltimes B}~(\eta)
\end{mathpar}
...
\begin{mathpar}
  ...
  \inferrule*
    {~}
    {B^A \times A \xlongrightarrow{\app} B}
\end{mathpar}
...
\begin{mathpar}
  \inferrule*
    ...
    {\Gamma \xlongrightarrow{\angled{f,g}} B^A \times A \xlongrightarrow{\app} B}
\end{mathpar}
  ...
  \inferrule*
    {
      ...
      \\
      \inferrule*{~}{B^A\times A \xlongrightarrow{\app} B}
    }
  ...
  \inferrule*
    {
      \inferrule*
        ...
        {\Gamma \times A \xlongrightarrow{\app \,\circ\, \angled{f\,\circ\, \pi_1, \pi_2}} B}
    }
    {\Gamma \xlongrightarrow{\lambda(\app \,\circ\, \angled{f\,\circ\,\pi_1,\pi_2})} B^A}
\end{mathpar}
