...
\section{Examples of with exponential objects}
...
logical formulae whose morphisms denote formula entailment. In the assignment
...
Suppose $\alpha$ and $\beta$ are logical formulae. Let $\gamma$ be 
some other logical formula
such that $\gamma \land \alpha \models \beta$. Then, an exponential object $\beta^\alpha$ 
is some object that enables the following diagram to commute:
...
\begin{tikzcd}
  ...
  \beta^\alpha \land \alpha  \arrow[r]               & \beta
  \end{tikzcd}
\end{center}
