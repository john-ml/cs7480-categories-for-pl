...
A $\calC$-indexed set is also known as a \emph{presheaf}.
...
\section{The category of $\calC$-indexed sets}
...
From this we can define conclude the following definition 
is well-formed:
...
This category is also called the category of presheaves on $\calC$.
