...
\begin{definition}[Category]
  ...
  \item $\mathsf{id} : O\to \{f \in M \mid \mathsf{dom}(f) = \mathsf{cod}(f)\}$
...
\item Order-theoretically, you use the fact that inequalities are transitive.
\item Algebraically, you use that \(u = fv = fgw\) provides a solution to \(u = hw\).
\end{itemize}
